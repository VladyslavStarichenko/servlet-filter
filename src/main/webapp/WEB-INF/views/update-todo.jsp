...
<nav class="navbar navbar-default">
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li style="margin-right: 20px"><a href="/sign-up.do" id="third">Sign Up
...
<div class="container">
    ...
    <form method="POST" action="/update-todo.do">
        <fieldset class="form-group">
            <label>Todo Task
                <input style="width: 300px;" name="newTodo" type="text" class="form-control"/> <BR/>
            </label>
        </fieldset>
        <fieldset class="form-group">
            <label>Category
                <input style="width: 300px;" name="newCategory" type="text" class="form-control"/> <BR/>
            </label>
        </fieldset>
        <hr>
